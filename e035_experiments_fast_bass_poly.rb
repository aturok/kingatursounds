...
live_loop :bass do
  ...
  with_fx :ping_pong, feedback: 0.05 do
    with_fx :lpf, cutoff: 60 do
      ...
      2.times do
        synth :dsaw, detune: 0.1, note: n, sustain: 0.5*0.33, release: 0.01
        sleep 0.5*0.33
        synth :dsaw, detune: 0.3, note: n, sustain: 0.32, release: 0.01, amp: 0.7
        sleep 0.33
      end
      
      5.times do
        synth :dsaw, detune: 0.3, note: n, sustain: 0.5*0.33, release: 0.01, amp: choose([0.7,0.85,1])
        sleep 0.5*0.33
      end
      synth :dsaw, detune: 0.1, note: n, sustain: 0.12, release: 0.01
    end
